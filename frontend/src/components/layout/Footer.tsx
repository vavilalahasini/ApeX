      ...
      <div className="px-[clamp(1.25rem,4vw,6rem)] py-16">
        <div className="grid gap-12 xl:grid-cols-[1.7fr_1fr] xl:items-start">
          <div className="space-y-8">
            ...
            {process.env.NEXT_PUBLIC_SHOW_SOCIAL === 'true' && (
              <div className="flex flex-wrap items-center gap-3">
                <a
                  href="https://www.instagram.com/YOUR_REAL_HANDLE"
                  target="_blank"
                  ...
                  aria-label="ApeX Studio on Instagram"
                >
                ...
                <a
                  href="https://www.linkedin.com/company/YOUR_COMPANY_SLUG"
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  aria-label="ApeX Studio on LinkedIn"
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
